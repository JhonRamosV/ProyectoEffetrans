<%-- 
    Document   : ofertasAceptadas
    Created on : 17/06/2022, 11:00:41 PM
    Author     : Pablo
--%>
                        ...
                        <div class="col-xl-12">
                            <div class="card text-center mb-12">
                                <div class="card-header justify-content-center">
                                    <h5 class="card-title"><%=oftVO.getDeptnombre()%>, <%=oftVO.getCiudnombre()%> </h5>
                                </div>
                                <div class="card-body">
                                    <p class="card-text"><%=oftVO.getEnvcomentario()%></p>
                                    <p class="card-text"><%=oftVO.getEnvdireccion()%></p>
                                    <a href="./Envio?txtidenvio=<%=oftVO.getIdenvio()%>&opcion=5" class="btn btn-primary">Realizar Envío</a>
                                </div>
