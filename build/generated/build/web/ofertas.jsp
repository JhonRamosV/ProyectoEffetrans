<%-- 
    Document   : ofertas
    Created on : 11/06/2022, 12:54:39 PM
    Author     : Pablo
--%>
                                            ...
                                            <table class="table table-responsive-md">
                                                ...
                                                <tbody>
                                                    ...
                                                    <%
                                                        ...
                                                        ArrayList<OfertaVO> ofert = (ArrayList) request.getAttribute("OfertaConsultada");
                                                    ...
                                                    <tr>
                                                        <td><%=oftVO.getNombreusuario()%></td>
                                                        <td><%=oftVO.getIdvehiculo()%> <%=oftVO.getMarca()%></td>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <a href="./Oferta?txtidoferta=<%=oftVO.getIdoferta()%>&opcion=3" class="card-link float-right">Aceptar Oferta</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <% }
