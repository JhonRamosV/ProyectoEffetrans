<%-- 
    Document   : ConsutarEnviosCliente
    Created on : 8/06/2022, 10:22:55 AM
    Author     : Pablo
--%>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row d-flex flex-column">                            
                        <form method="post" action="Oferta">
                            ...
                            <%
                                EnvioVO envVO = new EnvioVO();
                                EnvioDAO envDAO = new EnvioDAO();
                                String usu = idusuario;
                                ArrayList<EnvioVO> listarEnvio = envDAO.listarEnviosPropios(usu);
                                for (int i = 0; i < listarEnvio.size(); i++) {
                                    envVO = listarEnvio.get(i);

                            %>

                            <div class="col-xl-12">
                                <div class="card mb-12">
                                    <%                            String estado = envVO.getEstado();
                                    ...
                                    <div class="card-header">
                                        <h5 class="card-title"><%=envVO.getNombrecarga()%></h5>
                                    </div>
                                    <div class="card-body">
                                        <label for="" class="card-text">Fecha Límite: </label>
                                        <label for="" class="card-text"><%=envVO.getFecha_limite_llegada()%></label>
                                        <br>
                                        <label for="" class="card-text">Dirección: </label>
                                        <label for="" class="card-text"><%=envVO.getDireccion()%></label>
                                        <br>                                
                                        <label for="" class="card-text text-black font-w500">Lugar: </label>
                                        <label for="" class="card-text text-black font-w500"><%=envVO.getIddepartamento()%>, <%=envVO.getIdciudad()%></label>
                                    </div>
                                    <div class="card-footer">
                                        <p class="card-text d-inline text-warning font-w600"><%=envVO.getIdtipo_carga()%></p>
                                        <a href="./Oferta?txtidenvio=<%=envVO.getIdenvio()%>&opcion=2" class="card-link float-right">Ver ofertas</a>
                                    </div>
                                    <%}%>
                                </div>
                            </div>
