<%-- 
    ...
    Created on : 17/06/2022, 03:08:17 AM
    Author     : Pablo
--%>
                    ...
                    <div class="row">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="col-6">
                                        <h1>Los envíos serán más fáciles de realizar</h1>
                                        <h2>¡Empieza Ya!</h2>

                                        <div id="accordion-seven" class="accordion accordion-primary-solid accordion-bordered mt-5">
                                            <div class="accordion__item">
                                                <div class="accordion__header accordion__header--primary" data-toggle="collapse" data-target="#header-bg_collapseOne">
                                                    <span class="accordion__header--icon"></span>
                                                    <span class="accordion__header--text text-black font-w600">Publica envíos</span>
                                                ...
                                                <div id="header-bg_collapseOne" class="collapse accordion__body show" data-parent="#accordion-seven">
                                                    <div class="accordion__body--text text-black">
                                                        Diríjase al apartado de envíos y complete el formulario con la información requeridad 
                                                        para que se publique en la plataforma.
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion__item">
                                                <div class="accordion__header collapsed accordion__header--primary" data-toggle="collapse" data-target="#header-bg_collapseTwo">
                                                    <span class="accordion__header--icon"></span>
                                                    <span class="accordion__header--text text-black font-w600">Acepte Ofertas</span>
                                                    <span class="accordion__header--indicator"></span>
                                                </div>
                                                <div id="header-bg_collapseTwo" class="collapse accordion__body" data-parent="#accordion-seven">
                                                    <div class="accordion__body--text text-black">
                                                        Los conductores podrán realizar una oferta al envío publicado, donde podrá ver los detalles y
                                                        aceptar la que más le llame la atención.
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion__item">
                                                <div class="accordion__header collapsed accordion__header--primary" data-toggle="collapse" data-target="#header-bg_collapseThree">
                                                    <span class="accordion__header--icon"></span>
                                                    <span class="accordion__header--text text-black font-w600">Califique el Servicio</span>
                                                    <span class="accordion__header--indicator"></span>
                                                </div>
                                                <div id="header-bg_collapseThree" class="collapse accordion__body" data-parent="#accordion-seven">
                                                    <div class="accordion__body--text text-black">
                                                        Al terminar el servicio, podrá dar una calificación y/o un comentario al 
                                                        conductor según su experiencia con el servicio. 
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-6">
                                        <img src="images/cliente/Manufacturing Process-amico.svg" width="500" height="450" alt="">
                                    </div>
                                </div>
