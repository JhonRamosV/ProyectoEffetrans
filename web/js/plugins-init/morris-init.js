	...
	var dzMorris = function(){
		...
		var donutChart = function(){
			Morris.Donut({
				...
				resize: true,
				redraw: true,
				colors: ['#707070', 'rgb(243, 156, 18)', '#1bd084'],
				//responsive:true,
		...
		var lineChart = function(){
			...
			let line = new Morris.Line({
				...
				lineColors: ['rgb(243, 156, 18)'], //here
				lineWidth: 1,
				hideHover: 'auto',
				pointSize: 0,
				axes: false
		...
		var lineChart2 = function(){
			...
			Morris.Area({
				...
				lineWidth: 3,
				hideHover: 'auto',
				lineColors: ['rgb(243, 156, 18)', 'rgb(27, 208, 132)', '#707070'],
				resize: true
		...
		var barChart = function(){
			...
			Morris.Bar({
				...
				ykeys: ['a', 'b', 'c'],
				labels: ['A', 'B', 'C'],
				barColors: ['#F39C12', '#1bd084', '#ff9f00'],
				hideHover: 'auto',
				gridLineColor: 'transparent',
				resize: true,
				barSizeRatio: 0.25,
		...
		var areaChart = function(){
			...
			Morris.Area({
				...
				lineColors: ['#707070', 'rgb(16, 202, 147)', 'rgb(243, 156, 18)'],
				xkey: 'period',
				ykeys: ['smartphone', 'windows', 'mac'],
				labels: ['Phone', 'Windows', 'Mac'],
				pointSize: 0,
