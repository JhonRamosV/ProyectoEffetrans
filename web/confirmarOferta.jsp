<%-- 
    Document   : confirmarOferta
    Created on : 17/06/2022, 02:23:17 PM
    Author     : Pablo
--%>
    ...
    ***********************************-->
            <div class="content-body">
                ...
                <div class="container-fluid">
                    ...
                    <%
                        ConfirmacionEnvioVO confEnvVO = (ConfirmacionEnvioVO) request.getAttribute("ConfirmacionConsultada");
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header justify-content-center">
                                <h2 class="text-warning">Resumen</h2>
                            </div>
                            <form method="post" action="Pago">
                                <div class="card-body d-flex">
                                    <div class="col-6 border-right">
                                        <div>
                                            <label class="text-black" for="">Nombre destinatario:</label>
                                            <label class="ml-3" for=""><%=confEnvVO.getNombre_destinatario()%></label>
                                        </div>

                                        <div>
                                            <label class="text-black" for="">Apellido destinatario:</label>
                                            <label class="ml-3" for=""><%=confEnvVO.getApellido_destinatario()%></label>
                                        </div>

                                        <div>
                                            <label class="text-black" for="">Teléfono destinatario:</label>
                                            <label class="ml-3" for=""><%=confEnvVO.getTelefono_destinatario()%></label>
                                        </div>
                                    </div>

                                    <div class="col-6 align-self-center">
                                        <h4>Al confirmar se creara un pago que podrás realizar 
                                            al finalizar el envío.</h4>
                                    </div>
                                </div>
                                        
                                <input type="hidden" name="txtidconfirmacion_envio" value="<%=confEnvVO.getIdconfirmacion_envio()%>">
                                <input type="hidden" name="txtestado_pago" value="1">
                                <input type="hidden" name="txtvalor" value="<%=confEnvVO.getValor()%>">
                                
                                <div class="card-footer">
                                    <div class="col-12">
                                        <input type="hidden" name="opcion" value="1">
                                        <button class="btn btn-warning w-100 fs-15">Confirmar</button>
                                    </div>
                                </div>
                            </form>
