<%-- 
    Document   : Envios
    Created on : 15/06/2022, 10:39:43 AM
    Author     : Pablo
--%>
                                ...
                                <div class="table-responsive">
                                    <form method="Post" action="Usuario">
                                        <table class="table table-responsive-md">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th scope="row"><%=envVO.getIdusuario()%></th>
                                                    <td><%=envVO.getNombrecarga()%></td>
                                                    <td><%=envVO.getPeso()%></td>
                                                    <td><%=envVO.getCantidad()%></td>
                                                    <td><%=envVO.getLongitud()%></td>
                                                    <td><%=envVO.getFecha_registro()%></td>
                                                    <td><%=envVO.getDireccion()%></td>
                                                    <td><%=envVO.getIddepartamento()%></td>                        
                                                    <td><%=envVO.getIdciudad()%></td>
                                                    <td><%=envVO.getCodigo_postal()%></td>
                                                    <td><%=envVO.getFecha_limite_llegada()%></td>
                                                    <td><%=envVO.getComentario_envio()%></td>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <a href="./Envio?txtidenvio=<%=envVO.getIdenvio()%>&opcion=3" class="btn btn-danger shadow btn-xs sharp"><i
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <a href="./Envio?txtidenvio=<%=envVO.getIdenvio()%>&opcion=4" class="btn btn-success shadow btn-xs sharp mr-1"><i
