<%-- 
    Document   : administradorOferta
    Created on : 15/06/2022, 09:21:11 PM
    Author     : Pablo
--%>
                                ...
                                <div class="table-responsive">
                                    <form method="Post" action="Oferta">
                                        <table class="table table-responsive-md">
                                            <thead>
                                                <tr>
                                                    <th class="width250">Conductor</th>
                                                    <th>Carga</th>
                                                    <th>Vehiculo</th>
                                                    <th>Marca</th>
                                                    <th>Tipo de pago</th>
                                                    <th>Precio</th>
                                                    <th>Fecha de diponibilidad</th>
                                                    <th>Estado</th>
                                                    <th>Acciones</th>
                                                </tr>
                                            </thead>
                                            <%                        OfertaVO oftVO = new OfertaVO();
                                                ...
                                                ArrayList<OfertaVO> listaOferta = oftDAO.listar();
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th scope="row"><%=oftVO.getNombreusuario()%></th>
                                                    <td><%=oftVO.getIdenvio()%></td>
                                                    <td><%=oftVO.getIdvehiculo()%></td>
                                                    <td><%=oftVO.getMarca()%></td>
                                                    <td><%=oftVO.getIdtipo_pago()%></td>
                                                    <td><%=oftVO.getPrecio()%></td>
                                                    <td><%=oftVO.getFecha_disponibilidad()%></td>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <a href="./Oferta?txtidoferta=<%=oftVO.getIdoferta()%>&opcion=4" class="btn btn-danger shadow btn-xs sharp"><i
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <a href="./Oferta?txtidoferta=<%=oftVO.getIdoferta()%>&opcion=5" class="btn btn-success shadow btn-xs sharp mr-1"><i
