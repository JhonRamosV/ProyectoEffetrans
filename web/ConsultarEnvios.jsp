<%-- 
    Document   : ConsultarEnvios
    Created on : 27/05/2022, 09:26:16 AM
    Author     : Sena
--%>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row d-flex flex-column">
                        ...
                        <%                        EnvioVO envVO = new EnvioVO();
                            ...
                            ArrayList<EnvioVO> listaEnvio = envDAO.listar();
                            for (int i = 0; i < listaEnvio.size(); i++) {
                                envVO = listaEnvio.get(i);
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="card mb-12">
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="./Envio?txtidenvio=<%=envVO.getIdenvio()%>&opcion=2" class="card-link float-right">Ofertar</a>
                                </div>
                            </div>
                            <%}%>
                        </div> 
